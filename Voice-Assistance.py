...
def record_audio(ask=False):
    ...
    with speech.Microphone() as source:
            ...
            try:
                ...
                trans_to_eng = Lam.translate(voice_data, src='en', dest='en')
...
def respond(voice_data):
    if 'introduce yourself' in voice_data:
        alexis_speak('My name is Nutthakorn Nuansuwan. I am a teacher at Watraiking school, Thailand, in my free time I like to play computer game and listen to music.')
    if 'how old are you' in voice_data:
        alexis_speak('I am 100 years old')
    if 'what is your name' in voice_data:
        alexis_speak('My name is Nutthakorn')
    ...
    if 'exit' in voice_data:
        alexis_speak('Thank you, see you again later,goodbye.')
        exit()
